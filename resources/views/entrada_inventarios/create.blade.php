        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Crear Entrada Inventario</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-12 col-md-12">
                            {!! Form::open(['method' => 'POST', 'route' => ['guardar_nueva_entrada_inventario'], 'autocomplete' => 'off', 'class' => 'form-horizontal']) !!}
                            <div class="row">
