...
class EntradaInventarioController extends Controller
{
    ...
    {
        $list_inventarios = Inventarios::where('tipo_movimiento', 1)->get();

        return view('entrada_inventarios.index', compact('list_inventarios'));
    }
    ...
    public function create()
    {
        ...
        return view('entrada_inventarios.create', compact('articulos'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect('entradainventario')->with('msj', 'Entrada de inventario registrado exitosamente');
        } catch (Exception $e) {
            DB::rollback();

            return redirect('entradainventario')->with('msjError', 'Error al registrar los datos');
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('entrada_inventarios.show', compact('entrada', 'detalles'));
    }
    ...
    public function eliminar($id)
    {
        try {
            ...
            if ($entrada->delete()) {
                DB::commit();
                return redirect('entradainventario')->with('msj', 'Entrada de inventario eliminada exitosamente');
            } else {
                DB::rollback();
                return redirect('entradainventario')->with('msjError', 'Error al eliminar los datos');
            }
        } catch (Exception $e) {
            DB::rollback();
            return redirect('entradainventario')->with('msjError', 'Error al eliminar los datos');
